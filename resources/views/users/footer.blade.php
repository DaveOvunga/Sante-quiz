        ...
        <div class="row">
            ...
            <div class="contact-info-block col-lg-4 col-md-6">
                <div class="inner">
                    ...
                    <div class="text">
                        <a href="https://wa.me/243825296273">+243 825 296 273</a>
                    </div>
                </div>
            </div>
            <!-- Contact info Block -->
            ...
            <div class="contact-info-block col-lg-4 col-md-6">
                <div class="inner">
                    ...
                    <span class="sub-title">Addresse</span>
                    <div class="text">144, Blvd du 30 Juin 3ème niveau, Local A Immeuble Dijon Center Gombe / Kinshasa</div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="footer-widget about-widget">
                    <div class="widget-content">
                        ...
                        <ul class="social-icon-two">
                            ...
                            <li><a href="https://www.facebook.com/santequiz"><i class="fab fa-facebook"></i></a></li>
                            <!-- <li><a href="#"><i class="fab fa-pinterest"></i></a></li> -->
                            <li><a href="https://www.instagram.com/santequiz"><i class="fab fa-instagram"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
