					...
					<div class="blog-details__left">
						...
						<div class="blog-details__content">
							<ul class="list-unstyled blog-details__meta">
								...
								<li><a href="news-details.html"><i class="fas fa-comments"></i> 08
									Comments</a>
								</li>
							</ul>
							<h3 class="blog-details__title">We provide all types of insurance</h3>
					...
					<div class="sidebar">
								...
								<li>
									...
									<div class="sidebar__post-content">
										<h3> <span class="sidebar__post-content-meta"><i
											class="fas fa-user-circle"></i>Admin</span> <a href="news-details.html">Benefits of your life insurance</a>
										</h3>
									</div>
								</li>
								<li>
									...
									<div class="sidebar__post-content">
										<h3> <span class="sidebar__post-content-meta"><i
											class="fas fa-user-circle"></i>Admin</span> <a href="news-details.html">7 cool benefits of your life insurance</a> </h3>
									</div>
								</li>
								<li>
									...
									<div class="sidebar__post-content">
										<h3> <span class="sidebar__post-content-meta"><i
											class="fas fa-user-circle"></i>Admin</span> <a href="news-details.html">We provide all types of insurance</a> </h3>
									</div>
								</li>
							</ul>
						</div>
						<div class="sidebar__single sidebar__category">
							...
							<ul class="sidebar__category-list list-unstyled">
								...
								<li class="active"><a href="news-details.html">Car Insurance<span
									class="icon-right-arrow"></span></a></li>
								<li><a href="news-details.html">Job Insurance<span
									class="icon-right-arrow"></span></a> </li>
								<li><a href="news-details.html">Health Insurance<span
									class="icon-right-arrow"></span></a> </li>
								<li><a href="news-details.html">Wedding Insurance<span
									class="icon-right-arrow"></span></a> </li>
							</ul>
						</div>
